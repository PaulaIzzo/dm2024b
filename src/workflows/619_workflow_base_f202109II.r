...
TS_strategy_base9 <- function( pinputexps )
{
  ...
  param_local$train$training <- c(202012, 202011, 202010, 
                                  202009, 202008, 202007, 202005,202004, 202003, 202002, 202001, 201912, 201911, 201910, 201909, 201908, 201907, 201906, 201905, 201904, 201903, 201902, 201901 )
  param_local$train$validation <- c(202102)
  param_local$train$testing <- c(202103, 202104, 202105)
